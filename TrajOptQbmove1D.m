classdef TrajOptQbmove1D
    ...
    methods (Static)
        ...
        function [ traj ] = reachFastIlqr( robot, x0, xf, varargin )
            ...
            j = @(x,u,t)TrajOptQbmove1D.jReachFast(x, u, t, costpara);
            %%%
            opt_param = [];
            ...
            opt_param.T = tf;
            %%%
            opt_param.umax = [7; 7; 1];
            opt_param.umin = [-7; -7; 0];
        ...
        % x0, xf, tf, dt, m2min
            ...
            j = @(x,u,t)TrajOptQbmove1D.jReachSmooth( x, u, t, costpara);
            %%%
            opt_param = [];
