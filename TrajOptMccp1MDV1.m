classdef TrajOptMccp1MDV1
    % For Maccepavd with motor dynamics-V1: predefined u1 and q_m1
    % x: [ q, qdot, q_s, qdot-s]
    % u: u2 u3
    % dynamics: dynamics(obj, x, u23, t, u1ref, tref)
    properties
    end
